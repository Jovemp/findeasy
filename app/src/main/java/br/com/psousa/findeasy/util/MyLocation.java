...
public class MyLocation {
    ...
    public boolean getLocation(Context context, LocationResult result)
    {
        ...
        if(gps_enabled)
            lm.requestLocationUpdates(LocationManager.GPS_PROVIDER, 40000, 0, locationListenerGps);
        if(network_enabled)
            lm.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 40000, 0, locationListenerNetwork);
        //timer1=new Timer();
